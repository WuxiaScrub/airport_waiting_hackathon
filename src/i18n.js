...
const STRINGS = {
  ...
  en: {
    ...
    /* Control labels (aria) */
    'aria.pickaxe': 'Pickaxe',
    'aria.dynamite': 'Dynamite',
    'aria.action': 'Action',
    'aria.jump': 'Jump',
    ...
    'help.jump.k': 'JUMP',
    'help.jump.v': 'You fall now. Hold <b>JUMP</b> (or <b>Space</b>) to clear a ledge. Dig <b>steps</b>, not a pit — a sheer shaft is a one-way trip.',
    'help.mine.k': 'MINE',
    'help.mine.v': 'Hold the big button. Aim with the stick — push down to dig the floor, up for the ceiling.',
    'help.tools.k': 'TOOLS',
    'help.tools.v': 'Tap ⛏ / 🧨 to swap. Dynamite clears a 3×3 and blasts rock.',
    'help.bank.k': 'BANK IT',
  ...
  zh: {
    ...
    'help.jump.k': '跳跃',
    'help.jump.v': '你现在会下坠。长按 <b>跳跃</b>（或 <b>空格</b>）翻上台阶。要挖成<b>阶梯</b>，别挖成直井 —— 垂直竖井有去无回。',
    'help.mine.k': '挖掘',
    'help.mine.v': '按住大按钮。用摇杆瞄准 —— 向下推挖脚下，向上推挖头顶。',
    'help.tools.k': '工具',
    'help.tools.v': '点 ⛏ / 🧨 切换。炸药会清空 3×3 范围，连岩石也炸得开。',
    'help.bank.k': '存起来',
